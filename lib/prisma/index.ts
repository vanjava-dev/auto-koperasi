  ...
  try {
    ...
    const baseMock = {
      ...
      koperasi: {
        ...
        update: async () => ({ id: "KOP-MASTER", nama: "KSP Harapan Artha Nusantara" }),
      },
      pengaturanSistem: {
        findUnique: async () => ({
          id: "SET-MASTER",
          ...
          maxPinjamanAktif: 2,
          cronSecretKey: "koperasi_secure_cron_key_999",
          xenditWebhookToken: "xnd_callback_secure_token_abc123",
          updatedAt: new Date(),
        }),
        upsert: async () => ({
          id: "SET-MASTER",
